...
3. Go to [Admin Panel] -> Modules ->  Modules & Services , search for payfort plugin unser "Selection" tap , then activate Payfort FORT Gateway Module.
...
tested for prestashop version 1.7
