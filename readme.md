...
|     2.2.8      | * Security - Apple Pay merchant certificate and private key moved to non-web-accessible directory with randomized filenames <br/> * Security - Upgrade script migrates existing certificates from public /upload/ path                                                                                                                                                                        |
