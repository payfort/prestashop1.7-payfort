...
<form style="display:none" name="payfort_payment_form_installments" id="payfort_payment_form_installments" method="post"></form>
<div class="pf-iframe-background" id="div-pf-installments-iframe" style="display:none">
    <div class="pf-iframe-container">
        ...
        <div class="pf-iframe" id="pf_iframe_installments_content"></div>
    </div>
