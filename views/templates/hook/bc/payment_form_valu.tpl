			...
			{if $allow_downpayment }
				<div class="valu-amount">
					<div class="aps aps-pad-none">
						...
						<input type="text" value="{$downpayment_value|escape:'htmlall':'UTF-8'}" autocomplete="off" maxlength="6" placeholder="Amount" value="0" class="input-text valu_amount_field aps_valu_downpayment onlynum" />
					</div>
				</div>
			{/if}
			<div class="valu-amount">
				<div class="aps aps-pad-none">
					...
					<input type="text" value="" autocomplete="off" maxlength="6" placeholder="Amount" value="0" class="input-text valu_amount_field aps_valu_wallet_amount onlynum" />
				</div>
			</div>
			<div class="valu-amount">
				<div class="aps aps-pad-none">
					<label>{l s='Enter valU cashback amount (Optional):' mod='amazonpaymentservices'}</label>
					<input type="text" value="" autocomplete="off" maxlength="6" placeholder="Amount" value="0" class="input-text valu_amount_field aps_valu_cashback onlynum" />
				</div>
			</div>
